            ...
            <ul class="list">
                <li class="item-cart">
                    <div class="product-img-wrap">
                        <a href="#" title="Product"><img src="<?= Yii::$app->request->baseUrl ?>/img/product/cart_product_1.jpg"
                ...
                <li class="item-cart">
                    <div class="product-img-wrap">
                        <a href="#" title="Product"><img src="<?= Yii::$app->request->baseUrl ?>/img/product/cart_product_2.jpg"
                                                         alt="Product" class="img-responsive"></a>
                    </div>
                    <div class="product-details">
                        <div class="inner-left">
            ...
            <div class="cart-bottom">
                <div class="cart-form">
                    <div class="cart-note-form">
                        <label for="CartSpecialInstructions" class="cart-note cart-note_text_label small--text-center">Special
                            Offer:</label>
...
<div class="search-form-wrapper header-search-form">
    <div class="container">
        ...
        <form method="get" action="/search" role="search" class="search-form  has-categories-select">
            <input name="q" class="search-input" type="text" value="" placeholder="Enter your keywords..."
                   autocomplete="off">
            ...
            <div class="container container-content">
                <div class="row flex align-items-center justify-content-between">
                        ...
                        <div class="topbar-right">
                            <div class="element">
                                <a href="#" class="icon-pushmenu js-push-menu">
                                    <svg width="26" height="16" version="1.1" id="Layer_1"
                                         ...
                                         x="0px" y="0px" viewBox="0 0 66 41" style="enable-background:new 0 0 66 41;"
                                         xml:space="preserve">
                                            <style type="text/css">
                                                .st0 {
                                                    fill: none;
                            ...
                            <div class="element element-leaguage hidden-xs hidden-sm">
                                <a id="label2" class="dropdown-toggle" data-toggle="dropdown" role="button"
                                   aria-haspopup="true" aria-expanded="false">
                                    <img src="<?= Yii::$app->request->baseUrl ?>/img/icon-l.png" alt="">
                                    <span>EN</span>
                                    <span class="ion-arrow-down-b f-10 e-arrow"></span>
                                </a>
                    ...
                    <div class="col-md-4 col flex justify-content-center">
                        <a href="#"><img src="<?= Yii::$app->request->baseUrl ?>/img/logo.png" alt="" class="img-reponsive"></a>
                    </div>
                            ...
                            <div class="element element-search hidden-xs hidden-sm">
                                <a href="#" class="zoa-icon search-toggle">
                                    <svg width="20" height="20" version="1.1" id="Layer_2"
                                         xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                         x="0px" y="0px" viewBox="0 0 90 90" style="enable-background:new 0 0 90 90;"
                                         xml:space="preserve">
                                            <g>
                            ...
                            <div class="element element-user hidden-xs hidden-sm">
                                <a href="#" class="zoa-icon js-user">
                                    <svg width="19" height="20" version="1.1" id="Layer_3"
                                         xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                         x="0px" y="0px" viewBox="0 0 100 102.8"
                                         style="enable-background:new 0 0 100 102.8;" xml:space="preserve">
                                            <g>
                            ...
                            <div class="element element-cart">
                                <a href="#" class="zoa-icon icon-cart">
                                    <svg width="20" height="20" version="1.1" id="Layer_4"
                                         xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                         x="0px" y="0px" viewBox="0 0 55.4 55.4"
        ...
        <div class="shop-top">
            <div class="shop-element left">
                <ul class="js-filter">
                    ...
                    <li class="filter">
                        <a onClick="return false;" href=""><i class="zoa-icon-sort"></i>Sort by:
            ...
            <div class="row engoc-row-equal">
                <div class="col-xs-6 col-sm-4 col-md-15 col-lg-15 product-item">
                    <div class="product-img">
                        <a href=""><img src="<?= Yii::$app->request->baseUrl ?>/img/product/product_1.jpg" alt=""
                ...
                <div class="col-xs-6 col-sm-4 col-md-15 col-lg-15 product-item">
                    <div class="product-img">
                        <a href=""><img src="<?= Yii::$app->request->baseUrl ?>/img/product/product_2.jpg" alt=""
                                        class="img-responsive"></a>
                        <div class="ribbon zoa-hot"><span>Hot</span></div>
                        <div class="product-button-group">
                            <a href="#" class="zoa-btn zoa-quickview">
                ...
                <div class="col-xs-6 col-sm-4 col-md-15 col-lg-15 product-item">
                    <div class="product-img">
                        <a href=""><img src="<?= Yii::$app->request->baseUrl ?>/img/product/product_3.jpg" alt=""
                                        class="img-responsive"></a>
                ...
                <div class="col-xs-6 col-sm-4 col-md-15 col-lg-15 product-item">
                    <div class="product-img">
                        <a href=""><img src="<?= Yii::$app->request->baseUrl ?>/img/product/product_4.jpg" alt=""
                                        class="img-responsive"></a>
                        <div class="ribbon zoa-hot"><span>Hot</span></div>
                        <div class="product-button-group">
                            <a href="#" class="zoa-btn zoa-quickview">
                ...
                <div class="col-xs-6 col-sm-4 col-md-15 col-lg-15 product-item">
                    <div class="product-img">
                        <a href=""><img src="<?= Yii::$app->request->baseUrl ?>/img/product/product_5.jpg" alt=""
                                        class="img-responsive"></a>
                ...
                <div class="col-xs-6 col-sm-4 col-md-15 col-lg-15 product-item">
                    <div class="product-img">
                        <a href=""><img src="<?= Yii::$app->request->baseUrl ?>/img/product/product_6.jpg" alt=""
                                        class="img-responsive"></a>
                        <div class="ribbon zoa-hot"><span>Hot</span></div>
                        <div class="product-button-group">
                            <a href="#" class="zoa-btn zoa-quickview">
                ...
                <div class="col-xs-6 col-sm-4 col-md-15 col-lg-15 product-item">
                    <div class="product-img">
                        <a href=""><img src="<?= Yii::$app->request->baseUrl ?>/img/product/product_7.jpg" alt=""
                                        class="img-responsive"></a>
                        <div class="ribbon zoa-hot"><span>Hot</span></div>
                        <div class="product-button-group">
                            <a href="#" class="zoa-btn zoa-quickview">
                ...
                <div class="col-xs-6 col-sm-4 col-md-15 col-lg-15 product-item">
                    <div class="product-img">
                        <a href=""><img src="<?= Yii::$app->request->baseUrl ?>/img/product/product_8.jpg" alt=""
                                        class="img-responsive"></a>
                        <div class="product-button-group">
                            <a href="#" class="zoa-btn zoa-quickview">
                                <span class="zoa-icon-quick-view"></span>
                ...
                <div class="col-xs-6 col-sm-4 col-md-15 col-lg-15 product-item">
                    <div class="product-img">
                        <a href=""><img src="<?= Yii::$app->request->baseUrl ?>/img/product/product_9.jpg" alt=""
                                        class="img-responsive"></a>
                        <div class="product-button-group">
                            <a href="#" class="zoa-btn zoa-quickview">
                                <span class="zoa-icon-quick-view"></span>
                ...
                <div class="col-xs-6 col-sm-4 col-md-15 col-lg-15 product-item">
                    <div class="product-img">
                        <a href=""><img src="<?= Yii::$app->request->baseUrl ?>/img/product/product_10.jpg" alt=""
                                        class="img-responsive"></a>
                ...
                <div class="col-xs-6 col-sm-4 col-md-15 col-lg-15 product-item">
                    <div class="product-img">
                        <a href=""><img src="<?= Yii::$app->request->baseUrl ?>/img/product/product_11.jpg" alt=""
                                        class="img-responsive"></a>
                        <div class="ribbon zoa-hot"><span>Hot</span></div>
                        <div class="product-button-group">
                            <a href="#" class="zoa-btn zoa-quickview">
                ...
                <div class="col-xs-6 col-sm-4 col-md-15 col-lg-15 product-item">
                    <div class="product-img">
                        <a href=""><img src="<?= Yii::$app->request->baseUrl ?>/img/product/product_12.jpg" alt=""
                                        class="img-responsive"></a>
                        <div class="ribbon zoa-hot"><span>Hot</span></div>
                        <div class="product-button-group">
                            <a href="#" class="zoa-btn zoa-quickview">
                ...
                <div class="col-xs-6 col-sm-4 col-md-15 col-lg-15 product-item">
                    <div class="product-img">
                        <a href=""><img src="<?= Yii::$app->request->baseUrl ?>/img/product/product_13.jpg" alt=""
                                        class="img-responsive"></a>
                        <div class="product-button-group">
                            <a href="#" class="zoa-btn zoa-quickview">
                                <span class="zoa-icon-quick-view"></span>
                ...
                <div class="col-xs-6 col-sm-4 col-md-15 col-lg-15 product-item">
                    <div class="product-img">
                        <a href=""><img src="<?= Yii::$app->request->baseUrl ?>/img/product/product_14.jpg" alt=""
                                        class="img-responsive"></a>
                        <div class="product-button-group">
                            <a href="#" class="zoa-btn zoa-quickview">
                                <span class="zoa-icon-quick-view"></span>
