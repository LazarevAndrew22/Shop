    ...
    <div class="container container-content">
        <div class="zoa-about text-center">
            ...
            <div class="about-banner">
                <div class="hover-images"><img src="<?= Yii::$app->request->baseUrl ?>/img/about/about-banner.jpg" class="img-responsive" alt=""></div>
                <div class="zoa-info">
                    <div class="container">
                        <div class="zoa-inside flex align-items-center justify-center">
                            <p>Zoa - New York store. <span>OPEN</span> NOW</p>
...
<!--                        </div>-->
                    ...
                    <div class="about-info">
                        ...
                        <div class="about-desc">
                            ...
                            <p>Zoa stands for a personal and obstinate selection. Surprising with new designers every season, great attention is given to the unique & personal identity of all in-store designers. From clothing to jewellery, shoes & bags, each piece is chosen with special care.</p>
                        </div>
                        <div class="sign">
                            <img src="<?= Yii::$app->request->baseUrl ?>/img/about/signature.jpg" class="img-responsive" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-md-5 col-sm-6 col-xs-12">
                    <div class="about-img">
                        <div class="hover-images"><img src="<?= Yii::$app->request->baseUrl ?>/img/about/about-2.jpg" class="img-responsive" alt=""></div>
                    </div>
                </div>
            </div>
        </div>
